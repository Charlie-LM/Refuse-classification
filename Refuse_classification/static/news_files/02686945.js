...
var viewsSettings = {
    ...
    "layout_1561086480002": {
        "css": {
            ...
            "customCss": {
                "pc": {
                    "modelArea": {
                        "background": " url(\/userimg\/63355\/pkgimg\/banner\/banner12.jpg)",
    ...
    "text_style_01_1561086955357": {
        ...
        "css": {
            ...
            "customCss": {
                ...
                }, "mobile": {"@view_contents": {"font-size": "28px"}}
            },
            "content": {"overflow": "visible"}
        },
        "lock": {"height": "true"},
    ...
    "newsList_style_18_1561086911503": {
        "settingsBox": {
            "setList": {
                "\u5e38\u89c4": {
                    "isDefault": "true",
        ...
        "css": {
            ...
            "customCss": {
                "pc": {
                    "@titleSet": {"font-size": "18px", "line-height": "40px"},
                    "@detailSet": {
                        "font-size": "14px",
                        "text-indent": "2em",
                        "margin-right": "0px",
                ...
                "pad": {"@btnaSet": {"margin-left": "830px"}, "@detailSet": {"text-indent": "2em"}},
                "mobile": {
                    "@titleSet": {"line-height": "40px", "margin-top": "0px"},
                    "@btnaSet": {"margin-left": "0px"}
                }
            }
        },
        "lock": {"height": "true"},
        "data": {
            "newsShow": ["date", "title", "summary", "kind", "article", "page"],
            "sort": "id",
            "newsnum": 3,
            "column": 1,
            "titlenum": "36",
            "newPicScale": "1:1",
            "newpicwidth": "110",
            "detailnum": {"pc": "200", "pad": "100", "mobile": "36"},
            "newsGids": [281627],
            "newsSort": "idAsc"
        },
        "newtitle": "true",
